...
data = np.loadtxt("build/3_dh_out.txt")
data = np.array(data)
x = data[:, 0]
y = data[:, 1]
TABC = data[:, 2]
...
plt.text(8.02,4,'Atten. backs. coef. (532nm)',size=35,color='r')
...
plt.tick_params(which="major",width = 3,length=10)
plt.tick_params(which="minor",width = 3,length=5)
plt.text(8.02,4,'Extinction coefficient (532nm)',size=35,color='r')
...
plt.tick_params(which="major",width = 3,length=10)
plt.tick_params(which="minor",width = 3,length=5)
plt.text(8.02,4,'Color ratio (1064 nm/532nm)',size=35,color='r')
...
plt.tick_params(which="major",width = 3,length=10)
plt.tick_params(which="minor",width = 3,length=5)
plt.text(8.02,4,'Depolarization ratio (532nm)',size=35,color='r')
...
plt.tick_params(which="major",width = 3,length=10)
plt.tick_params(which="minor",width = 3,length=5)
plt.text(8.02,4,'Vol. conc.',size=35,color='r')
...
plt.tick_params(which="major",width = 3,length=10)
plt.tick_params(which="minor",width = 3,length=5)
plt.text(8.02,4,'Eff. radius',size=35,color='r')
