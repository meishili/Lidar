...
data = np.loadtxt("build/3_zy_out.txt")
data = np.array(data)
x = data[:, 0]
y = data[:, 1]
TABC = data[:, 2]
...
plt.text(9.02,4,'Atten. backs. coef. (532nm)',size=35,color='r')
...
plt.tick_params(which="major",width = 3,length=10)
plt.tick_params(which="minor",width = 3,length=5)
plt.text(9.02,4,'Extinction coefficient (532nm)',size=35,color='r')
plt.scatter(x,y,c = extinction, vmin = 0, vmax = 0.5, s = scatter_size, cmap = plt.get_cmap("jet"))
cb=plt.colorbar()
...
plt.tick_params(which="major",width = 3,length=10)
plt.tick_params(which="minor",width = 3,length=5)
plt.text(9.02,4,'Color ratio (1064 nm/532nm)',size=35,color='r')
...
plt.tick_params(which="major",width = 3,length=10)
plt.tick_params(which="minor",width = 3,length=5)
plt.text(9.02,4,'Depolarization ratio (532nm)',size=35,color='r')
...
plt.tick_params(which="major",width = 3,length=10)
plt.tick_params(which="minor",width = 3,length=5)
plt.text(9.02,4,'Vol. conc.',size=35,color='r')
...
plt.tick_params(which="major",width = 3,length=10)
plt.tick_params(which="minor",width = 3,length=5)
plt.text(9.02,4,'Eff. radius',size=35,color='r')
